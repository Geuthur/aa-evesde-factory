 ...
 * @param {string} [namespace=aa-evesde-factory] Namespace for the tooltip
 * @param {string} [trigger=hover] Trigger for the tooltip ('hover', 'click', etc.)
 * @returns {void}
 */
const _bootstrapTooltip = ({selector = 'body', namespace = 'aa-evesde-factory', trigger = 'hover'} = {}) => {
...
const _bootstrapPopOver = ({selector = 'body', namespace = 'aa-evesde-factory', trigger = 'hover'} = {}) => {
 ...
 * @param {string} [exportFileName='aa-evesde-factory.csv'] - The name of the exported CSV file.
 * @throws Will throw an error if the table is not a valid DataTables instance.
 * @returns {void}
 */
const _exportToCSV = (DataTable, exportFileName = 'aa-evesde-factory.csv') => {
