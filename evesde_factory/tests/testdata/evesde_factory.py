...
# AA EVE SDE Factory
from evesde_factory.tests.testdata.factory import (
    EveCharacterFactory,
    UserFactory,
)
from evesde_factory.tests.testdata.utils import add_character_to_user


class UserMainFactory(UserFactory):
    """Generate a User object with a main character and default permissions for Belt Radar."""

    permissions__ = ["evesde_factory.basic_access"]
    scopes__ = ["publicData"]
